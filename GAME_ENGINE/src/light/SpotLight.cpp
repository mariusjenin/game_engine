...
SpotLight::SpotLight(glm::vec3 ambient, glm::vec3 diffuse, glm::vec3 specular, GLuint id_texture_shadow_map, float inner_cut_off_angle, float outer_cut_off_angle, float resol, float z_near, float z_far,
    ...
    m_light_behaviors.push_back(new SpotLightBehavior(id_texture_shadow_map,inner_cut_off_angle,outer_cut_off_angle,resol,z_near,z_far));
}
