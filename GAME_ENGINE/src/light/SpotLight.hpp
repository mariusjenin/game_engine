...
namespace light {
    ...
    public:
          ...
          */
        explicit SpotLight(glm::vec3 ambient, glm::vec3 diffuse, glm::vec3 specular, GLuint id_texture_shadow_map,
                           float inner_cut_off_angle = 20.f, float outer_cut_off_angle = 25.f, int resol = 1000,
                           float z_near = 1.0f, float z_far = 1000.f,
                           float bias = 0.001f, float constant_attenuation = 0.f, float linear_attenuation = 0.f,
