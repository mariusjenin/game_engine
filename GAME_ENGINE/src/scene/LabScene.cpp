...
LabScene::LabScene(GLFWwindow *window, const std::string &vertex_shader_path, const std::string &fragment_shader_path, float mult_physics
) : Scene(
    ...
    light_node->set_material(new MaterialColor({1., 1., 0.8}, 50));
    ...
    cube->set_material(new MaterialColor({0.75, 0.3, 0.95}, 50));
    ...
    m_ball->set_material(new MaterialColor({0.2, 0.3, 0.6}, 10));
...
//    //CAMERA
   ...
   m_cameras.push_back(camera_node);
    ...
    //DOORS
    DoorElement* door_1 = new DoorElement(m_root, OBB_TYPE, id_left_wall_texture, id_right_wall_texture);
    ...
    //OUT OF SCENE
    DoorElement* door_2 = new DoorElement(m_root, OBB_TYPE, id_left_wall_texture, id_right_wall_texture);
    ...
    //BTN
    ButtonElement* button_1 = new ButtonElement(m_root, OBB_TYPE);
    ...
    ButtonElement* button_2 = new ButtonElement(m_root, OBB_TYPE);
