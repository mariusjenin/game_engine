...
SceneLand::SceneLand(GLFWwindow *window, const std::string &vertex_shader_path, const std::string &fragment_shader_path, float mult_physics) : Scene(window,
...
void SceneLand::process_input(float delta_time) {
