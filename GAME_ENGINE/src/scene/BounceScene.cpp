...
BounceScene::BounceScene(const std::string &vertex_shader_path, const std::string &fragment_shader_path) : Scene(
...
//    auto *plane_mesh2 = new LODMesh(create_plane(100, 100, {-10, 0, -10}, {10, 0, 10}, Y_INV_NORMAL_DIRECTION), 2, 30, 60, 5, 10,AABB_TYPE);
    ...
    camera_node->get_trsf()->set_translation({0, 30, 28});
    camera_node->get_trsf()->set_rotation({-40, 0, 0});
...
void BounceScene::process_input(GLFWwindow *window, float delta_time) {
