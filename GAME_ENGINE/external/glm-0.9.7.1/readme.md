...
```c++
#include <glm/glsl_vec3.hpp> // glm::glsl_vec3
...
glm::mat4 camera(float Translate, glm::vec2 const & Rotate)
{
	...
	glm::mat4 View = glm::translate(glm::mat4(1.0f), glm::glsl_vec3(0.0f, 0.0f, -Translate));
	View = glm::rotate(View, Rotate.y, glm::glsl_vec3(-1.0f, 0.0f, 0.0f));
	View = glm::rotate(View, Rotate.x, glm::glsl_vec3(0.0f, 1.0f, 0.0f));
	glm::mat4 Model = glm::scale(glm::mat4(1.0f), glm::glsl_vec3(0.5f));
...
- Fixed GTX_polar_coordinates euclidean function, takes a vec2 instead of a glsl_vec3
...
--------------------------------------------------------------------------------
#### GLM 0.1 - 2005-02-21
- Add vec2, glsl_vec3, vec4 GLSL types
